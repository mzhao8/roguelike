...
class Message:
    ...
    def full_text(self) -> str:
        """Full text of the message, including the count if necessary"""
        if self.count > 1:
...
class MessageLog:
    ...
    def add_message(
        ...
        *,
        ...
        """add a message to this log. 'text' is the message text, 'fg' is the color
    ...
    def render(
        ...
        """ Render this log over the given dimensions x, y, width, height"""
